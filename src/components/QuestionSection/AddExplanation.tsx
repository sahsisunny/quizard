...
function AddExplanation({
  ...
  return (
    <div className="flex flex-col gap-4 p-2 bg-gray-900 text-white">
      <div className="flex justify-between items-center gap-4">
        ...
        >
          ...
          <span className="hidden sm:block text-sm">Back to the question</span>
        </button>
      ...
      <div className="flex flex-row gap-2 w-full  rounded">
        <div className="w-1/4 flex flex-col justify-center items-center gap-2 border-2 border-dashed rounded">
          <div className="flex flex-col justify-center items-center gap-2 cursor-pointer">
            <CiImageOn className="text-8xl" />
            <span className="text-sm">Add Cover Image</span>
          </div>
        </div>
        <div className="w-3/4 rounded border-2 border-dashed">
          <TextEditor
